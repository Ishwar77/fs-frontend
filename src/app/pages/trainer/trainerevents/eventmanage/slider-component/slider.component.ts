...
@Component({
    selector: 'app-slider-layout-create',
    templateUrl: './slider.component.html',
    styleUrls: ['./slider.component.scss']
})
export class SliderComponentLayout implements OnInit {
    ...
    config: AngularEditorConfig = {
        ...
        toolbarHiddenButtons: [
            [
                'undo','redo','strikeThrough','subscript','superscript','justifyLeft','justifyCenter','justifyRight','indent',
                'outdent','insertUnorderedList','insertOrderedList','heading','fontName','fontSize','textColor','backgroundColor',
                'customClasses','insertHorizontalRule','removeFormat','toggleEditorMode'
            ]
        ],
    };
    ...
    saveAction() {
        ...
        this._model.image = this.selectedFile;
    ...
    public getPanelTitle(header = true) {
        ...
        switch (this._model.viewMode) {
            case SliderViewMode.CREATE: return header ? 'Create Event' : 'add';
            case SliderViewMode.EDIT: return header ? 'Edit Event' : 'add';
            case SliderViewMode.INFO: return header ? 'Event Info' : 'edit';
        }
    }
    ...
    updatedate(event) {
        ...
        this.model['enddate'] = new Date(event);
    }
    closesilder() {
